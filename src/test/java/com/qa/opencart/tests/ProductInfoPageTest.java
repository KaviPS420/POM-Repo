...
public class ProductInfoPageTest extends BaseTest{
	...
	@Test(dataProvider = "getProductImageSheetData", groups = {"sanity"})
	public void productImagesCountTest(String searchKey, String productName, String imagesCount) {
		searchResultsPage = accPage.doSearch(searchKey);
		productInfoPage = searchResultsPage.selectProduct(productName);
		Assert.assertEquals(productInfoPage.getProductImagesCount(), Integer.parseInt(imagesCount), AppErrors.IMAGES_COUNT_MISMATCHED);
	}
